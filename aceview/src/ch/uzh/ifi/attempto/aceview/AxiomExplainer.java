...
public class AxiomExplainer {
	...
	public Set<Set<ACESnippet>> getExplanations() {
		ACEText<OWLEntity, OWLLogicalAxiom> activeAcetext = ACETextManager.getInstance().getActiveACEText();
	...
	private Set<Set<OWLAxiom>> getAxiomSets() {
		...
		BlackBoxExplanation exp = new BlackBoxExplanation(ACETextManager.getInstance().createOWLOntologyManager());
