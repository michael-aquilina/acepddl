...
public class UpdateAnswersUI {
	...
	public void updateAnswers() {
		...
		/*
		 * TODO: BUG: This doesn't work anymore, maybe not needed try { if (!
		 * mngr.getReasoner().isClassified()) { showMessage(JOptionPane.WARNING_MESSAGE,
		 * NSYNC_MESSAGE); } } catch (OWLReasonerException e) {
		 * showMessage(JOptionPane.ERROR_MESSAGE, e.getMessage()); return; }
		 */

		progressMonitor = new ProgressMonitor(parent, "Updating answers to " + questionCount + " questions...", "", 0,
				questionCount);
