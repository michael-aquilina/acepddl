...
public class SnippetsTableModel extends AbstractSnippetsTableModel {
	...
	public SnippetsTableModel() {
		snippets = ACETextManager.getInstance().getActiveACEText().getSnippets();
	...
	public Object getValueAt(int row, int column) {
		...
		case SHARED:
			return ACETextManager.getInstance().getActiveACEText().getSharedAxioms(snippet).size();
		case MESSAGES:
		...
		case ANNOTATIONS:
			return ACETextManager.getInstance().getAnnotationsExceptAcetext(snippet).size();
		default:
