...
public class CreateAceWikiAction extends ProtegeOWLAction {
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		TokenMapper tokenMapper = ACETextManager.getInstance().getActiveACELexicon();
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			if (filename != null && filename.length() > 0) {
				AceWikiRenderer renderer = new AceWikiRenderer(ACETextManager.getInstance().getActiveACEText());
				try {
