...
public class ACEFeedbackViewComponent extends AbstractACESnippetSelectionViewComponent {
	...
	private final JEditorPane editorpaneAxioms = new JEditorPane("text/html", ACETextManager.getInstance().wrapInHtml(""));
	// BUG: magic number
	...
	private void resetUI() {
		...
		editorpaneAxioms.setText(ACETextManager.getInstance().wrapInHtml(""));
	...
	private void updateAnnotations(ACESnippet snippet) {
		List<OWLAnnotation> annotations = ACETextManager.getInstance().getAnnotations(snippet);
	...
	private void updateAxioms(ACESnippet snippet) {
		...
		editorpaneAxioms.setText(ACETextManager.getInstance().wrapInHtml(axiomsAsHtml));
	}
	...
	private void updateSimilarSnippets(ACESnippet snippet) {
		...
		Set<ACESnippet> similarSnippets = ACETextManager.getInstance().getActiveACEText().getSimilarSnippets(snippet);
