...
/**
 * This enumeration defines the connective that can be used in PDDL expressions
 * implemented by the class <code>Exp</code>.
 *
 * @author D. Pellier
...
public enum Connective
{
    ...
    TIME_VAR(""),
    /**
     * The connective for ground function expression used in initial fact
     * expressions.
     */
    FN_ATOM("="),
    /**
     * The connective for ground function expression used in goal metric
     * expressions.
     */
    FN_HEAD(""),
    /**
     ...
     *
     * @param image the image of the connective. The image of the connective
     *            must be not null.
     */
