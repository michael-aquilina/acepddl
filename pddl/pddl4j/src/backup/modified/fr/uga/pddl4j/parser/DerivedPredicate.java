...
public class DerivedPredicate implements Serializable
{
    ...
    /**
     * Normalizes the derived predicates, i.e, renames the variables contained
     * in the derived predicate and move the negation inward.
     *
     ...
     * @return <code>true</code> if <code>obj</code> is not <code>null</code>,
     *         is an instance of the class <code>DerivedPredicate</code> and has
     *         the same head and body; otherwise it returns <code>false</code>.
