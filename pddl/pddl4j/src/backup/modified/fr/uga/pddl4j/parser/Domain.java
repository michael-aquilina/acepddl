...
import fr.uga.pddl4j.util.ACEPlannerOp;
...
public class Domain implements Serializable
{
     ...
     * @return <code>true</code> if the requirement was added;
     ...
     * @return <code>true</code> if the constant was added; <code>false</code>
     *         otherwise.
     ...
     * @return <code>true</code> if the predicate was added; <code>false</code>
     *         otherwise.
     ...
     * @return <code>true</code> if the function was added; <code>false</code>
     *         otherwise.
     ...
     *
     * @return the constraints loaded in the domain file or null if the domain
     *         has no constraints.
     */
     ...
     */
    public final List<ACEPlannerOp> getOperators()
    {
        return this.ops;
    }
     ...
     * @return <code>true</code> if the operator was added; <code>false</code>
     *         otherwise.
     * @throws NullPointerException if the specified operator is null.
     */
    public final boolean addOperator(final ACEPlannerOp op)
    {
        if (op == null)
        {
            throw new NullPointerException();
     ...
     * @return <code>true</code> if the derived predicate was added;
     *         <code>false</code> otherwise.
     * @throws NullPointerException if the specified predicate is null.
     */
     ...
     * @return <code>true</code> if the specified symbol is a declared type;
     *         <code>false</code> otherwise.
     */
     ...
     * @return the type from a specified symbol or <code>null</code> if no type
     *         with this symbol was declared.
     */
     ...
     * @return <code>true</code> if the specified symbol is a declared constant;
     *         <code>false</code> otherwise.
     */
     ...
     *
     * @param symbol The symbol.
     * @return the constant from a specified symbol or <code>null</code> if no
     *         constant with this symbol was declared.
     */
     ...
     * @return <code>true</code> if the specified object is a non
     *         <code>null</code> instance of the class <code>PlDomain</code> and
     *         has the same name; <code>false</code> otherwise.
     */
    @Override
    ...
    /**
     * Normalize the domain. This method rename the variables used in the domain
     * and normalize its ops and derived predicates.
     *
     * @see Op#normalize()
...
//        }
//        // Rename all the variables from the constraints declaration of the
//        // domain
...
//        }
    ...
    public String toString()
    {
        ...
        str.append("(define (domain ").append(this.name).append(")")
                .append("\n(:requirements");
        ...
        if (!this.types.isEmpty())
        {
            str.append("(:types ");
            this.types.stream()
                    .filter(type -> !type.equals(Parser.OBJECT)
                            && !type.equals(Parser.NUMBER))
        ...
        {
            str.append("(:constraints ").append("  ").append(this.constraints)
                    .append(")\n");
        }
