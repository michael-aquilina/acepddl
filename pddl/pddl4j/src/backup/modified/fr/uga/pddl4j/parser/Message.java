...
public class Message implements Serializable, Comparable<Message>
{
     ...
     */
    public Message(final Type type, final int line, final int column,
            final File file, final String content)
    {
    ...
    /**
     * Returns if an object is equals to this message. The method returns
     * <code>true</code> if the object is not <code>null</code> and is an
     * instance of the class <code>Message</code> and it has the same line,
     * column and file.
     *
     * @param obj the other object.
     * @return <code>true</code>if an object is equals to this message;
     *         <code>false</code>.
    ...
    /**
     * Compare this message to another message. The order used to compare two
     ...
     * @return a negative number if this message comes before the other message,
     *         0 is the message are equals or a positive number if this message
     *         comes after the other one according to the defined order.
    ...
    public String toString()
    {
        ...
        str.append(" at line ").append(this.line).append(", column ")
                .append(this.column).append(", file (").append(this.file)
