...
public class BitState extends BitVector
{
    ...
    /**
     * Creates a new state from an other state. This constructor is the copy
     * constructor.
     *
    ...
    /**
     * Applies a specified <code>BitExp</code> to this state. In other word, the
     * positive facts of the specified expression are added to this state and
     * the negative ones are delete.
     *
     ...
     * @return <code>true</code> if this state satisfy a specified expression;
    ...
    public final boolean satisfy(final BitExp exp)
    {
        ...
        return this.include(exp.getPositive())
                && this.exclude(exp.getNegative());
