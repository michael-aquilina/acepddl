...
public class CondBitExp implements Serializable
{
    ...
    /**
     * Creates a conditional bit expression from an other. This constructor is
    ...
    /**
     * Creates a new conditional expression with some specified conditions and
     * effects.
     *
    ...
    /**
     * Returns <code>true</code> if a specified object is equal to this
     * conditional expression. In other words, returns <code>true</code> if the
     * specified object is an instance of the same type as this instance, all of
     * whose members (conditions and effects) are equal to the corresponding
     * member of this conditional expression.
     *
     * @param obj the reference object with which to compare.
     * @return <code>true</code> if a specified object is equal to this
     *         conditional expression; <code>false</code>.
