...
public class TemporalPlan extends AbstractPlan
{
    ...
    public final double makespan()
    {
        ...
        if (!this.isEmpty())
        {
            ...
            final BitOp action = this.actions.lastEntry().getValue().stream()
     ...
     *         otherwise.
     * @see Plan#add(int, ACEPlannerActionModel)
     */
    @Override
     ...
     * @see Plan#remove(int, ACEPlannerActionModel)
     */
    @Override
     ...
     *         otherwise.
     * @see Plan#contains(int, ACEPlannerActionModel)
     */
    @Override
     ...
     * method of the class ACEPlannerActionModel to compare actions.
     *
     * @param obj the object to be compared.
     *
     * @return <code>true</code> if this plan is equal to the specified object;
     *         <code>false</code> otherwise.
     * @see ACEPlannerActionModel#equals(Object)
