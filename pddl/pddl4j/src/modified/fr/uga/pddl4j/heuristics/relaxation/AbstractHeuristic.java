...
public abstract class AbstractHeuristic implements Heuristic
{
    ...
    /**
     * Create a new heuristic for a specified planning problem. By default the
     * heuristic is considered as admissible.
     *
    ...
    /**
     * Returns the goal of the relaxed problem to solve in order to compute the
     * heuristic.
     *
     * @return the goal.
     */
    ...
    /**
     * Returns the relevant facts of the relaxed problem to solve in order to
    ...
    /**
     * Returns the operators of the relaxed problem to solve in order to compute
     * the heuristic.
     *
     * @return the operators.
     */
    protected final List<ACEPlannerBitOp> getOperators()
    {
