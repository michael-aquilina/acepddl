...
public class Op implements Serializable
{
    ...
    /**
     * The goal description that represents the constraints duration of temporal
     * operator.
     */
    ...
    public Op(final Op other)
    {
        ...
        this.parameters.addAll(other.getParameters().stream()
     ...
     * @param preconds The goal description that represents the preconditions of
     *            the operator.
     * @param effects The goal description that represents the effects of the
     *            operator.
     */
    public Op(final Symbol name, final List<TypedSymbol> parameters,
            final Exp preconds, final Exp effects)
    {
     ...
     * @param name The name of the operator.
     * @param parameters The list of parameters of the operator.
     * @param preconditions The goal description that represents the
     *            preconditions of the operator.
     * @param effects The goal description that represents the effects of the
     *            operator.
     * @param duration The goal description that represents the duration
     *            constraints of the operator.
     * @throws NullPointerException if the specified name, parameters,
     *             preconditions or effects are null.
     */
    public Op(final Symbol name, final List<TypedSymbol> parameters,
            final Exp preconditions, final Exp effects, final Exp duration)
    {
        this();
        if (name == null || parameters == null || preconditions == null
                || effects == null)
        {
            throw new NullPointerException();
        }
     ...
     * @return the parameter of the operator that has a specified symbol or
    ...
    /**
     * Returns the goal description that represents the preconditions of the
     * operator.
     *
     * @return The goal description that represents the preconditions of the
     *         operator.
     */
     ...
     *
     * @param preconditions The new goal description that represents the
     *            preconditions of the operator to set.
     ...
     *
     * @param effects he new goal description that represents the effects of the
     *            operator to set.
    ...
    /**
     * Returns the goal description that represents the duration constraints of
     * the operator.
     *
     * @return the goal description that represents the duration constraints of
     *         the operator.
     */
     ...
     *         <code>null</code>, is an instance of the class <code>Op</code>,
     *         and has the same name; otherwise it returns <code>false</code>.
    ...
    public String toString()
    {
        ...
        {
            str.append(
                    this.parameters.get(this.parameters.size() - 1).toString());
        }
        str.append(")");
        if (this.duration != null)
        {
