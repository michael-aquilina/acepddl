...
public final class Node extends BitState
{
     ...
     */
    public Node(BitState state, Node parent, int operator, int cost,
            int heuristic)
    {
        super(state);
        this.parent = parent;
    ...
    /**
     * Returns if a node is equal to an other object. The equals method has the
     * same behaviour as the equals method of the class BitState.
     *
     * @param obj the other oject.
     * @return <code>true</code> if the node is equal to the other specified
    ...
    /**
     * Returns the hash code value of the node. The hashcode method has the same
     * behaviour as the hashcode method of the class BitState.
     *
