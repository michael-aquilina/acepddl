...
/**
 * This class is used to encode expressions in compact encoding, i.e., with
...
public class IntExp implements Serializable
{
    ...
    /**
     * The list of arguments of the expression. This attribute is used to store
     * the argument of the atomic expression.
     */
    ...
    /**
     * The value of the expression. This attribute is used to store value of
     * number expression.
     */
    private double value;

    /**
     * Create a new expression from an other one. This constructor make a deep
     * copy of the specified expression.
     *
    ...
    public IntExp(final IntExp other)
    {
        ...
        {
            this.arguments = Arrays.copyOf(other.getArguments(),
                    other.getArguments().length);
        }
        List<IntExp> otherChildren = other.getChildren();
        this.children = new ArrayList<>(otherChildren.size());
        this.children.addAll(otherChildren.stream().map(IntExp::new)
    ...
    /**
     * Affect this expression to an other. After affectation this expression and
     * the other are equal. No copy of the content of the other expression is
     * done.
     *
