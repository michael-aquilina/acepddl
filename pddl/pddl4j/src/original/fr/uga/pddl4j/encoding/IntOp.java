...
/**
 * This class implements an operator. This class is used to store compact
 * representation of operator during the instantiation process.
 *
 * @author D. Pellier
...
final class IntOp extends AbstractCodedOp
{
    ...
    /**
     * Create a new operator from a specified operator. This constructor create
     * a deep copy of the specified operator.
     *
     ...
     * @return <code>true</code> if the operator is ready instantiate with the
     ...
     *         class Op and it has the same name and instantiated parameters;
    ...
    public boolean equals(final Object obj)
    {
        if (obj != null && obj instanceof IntOp)
        {
            ...
            return this.name.equals(other.name)
                    && Arrays.equals(this.instantiations, other.instantiations);
        }
        return false;
    }
