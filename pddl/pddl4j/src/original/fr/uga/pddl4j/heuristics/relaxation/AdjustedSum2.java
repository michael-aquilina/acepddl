...
/**
 * This class implement the adjusted sum 2 heuristic. This heuristic improves
 * the adjusted sum heuristic by replacing the computation of the
 * <code>cost(S)</code> by the used the relaxed plan heuristic. Now, we have the
 * following heuristic:
 * 
 * <pre>
 ...
 * <li><code>delta(S) := lev(S) - max(lev(p))</code> for all <code>p</code> in
 * <code>S</code>
 * </ul>
...
public final class AdjustedSum2 extends RelaxedGraphHeuristic
{
    ...
    /**
     * Creates a new <code>AdjustedSum2</code> heuristic for a specified
     * planning problem.
     *
    ...
    public int estimate(final BitState state, final BitExp goal)
    {
        ...
        return super.isGoalReachable()
                ? super.getRelaxedPlanValue() + (level - super.getMaxValue())
                : Integer.MAX_VALUE;
    }
