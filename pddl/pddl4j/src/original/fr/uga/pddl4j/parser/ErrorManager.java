...
public class ErrorManager implements Serializable
{
    ...
    /**
     * Print the messages log in the error manager that concerns a specific
     * file.
     *
     * @param file The file.
     */
    ...
    /**
     * Print the messages log in the error manager of a specific and concerning
     * a specific file.
     *
     * @param type the type of message to print.
     * @param file the file.
    ...
    {
        return this.msg.stream()
                .filter(message -> message.getFile().equals(file))
                .collect(Collectors.toCollection(LinkedHashSet::new));
    }

    /**
     * Returns the list of messages of a specific type concerning a specific
     * file.
     *
     * @param type The type of messages.
     * @param file The file.
     * @return The list of messages of a specific type concerning a specific
     *         file.
     */
    ...
    {
        this.msg.add(new Message(Message.Type.PARSER_ERROR, line, column, file,
                msg));
    }
    ...
    {
        this.msg.add(new Message(Message.Type.LEXICAL_ERROR, line, column, file,
                msg));
    }
    ...
    {
        this.msg.add(new Message(Message.Type.PARSER_WARNING, line, column,
                file, msg));
    }
