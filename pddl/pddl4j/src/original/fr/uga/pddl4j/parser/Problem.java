...
public class Problem implements Serializable
{
     ...
     * @return <code>true</code> if the fact was added; <code>false</code>
     *         otherwise.
     */
    ...
    /**
     * Returns the problem constraints loaded or <code>null</code> if the
     * problem has no constraints.
     *
     * @return the problem constraints loaded or <code>null</code> if the
     *         problem has no constraints.
     */
    ...
    /**
     * Returns the metric of the problem or <code>null</code> if the problem has
     * no metric specification.
     *
     * @return the metric of the problem or <code>null</code> if the problem has
     *         no metric specification.
     */
     ...
     * @return the object from a specified symbol or <code>null</code> if no
     *         object with this symbol was declared.
     */
    ...
    /**
     * Normalize the problem. This method renames the variables and then move
     * inward the negation of the goal and the constraints of the problem.
     *
     * @see Op#normalize()
    ...
    public String toString()
    {
        ...
        str.append("(define (problem ").append(this.name).append(")")
        ...
        str.append("\n)\n").append("(:goal ").append("  ").append(this.goal)
                .append(")\n");
        ...
        if (this.metric != null)
        {
            str.append("(:metric ").append("  ").append(this.metric)
                    .append(")\n");
        }
        str.append(")");
        return str.toString();
