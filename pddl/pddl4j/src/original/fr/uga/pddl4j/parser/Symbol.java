...
/**
 * This class implements a symbol parsed by the parser. It can be a predicate, a
 * functor, a constant, a kind, a variable and a preference.
 *
 * @author D. Pellier
...
public class Symbol implements Serializable
{
     ...
     */
    public Symbol(final Kind kind, final String image, final int beginLine,
    ...
    /**
     * Creates a new symbol with a specified image. The line and the column are
     * initialize to <code>-1</code>.
     *
     * @param kind the kind of the symbol.
     * @param image the string image of the symbol.
     */
    ...
    /**
     * Return the begin line of the file where this symbol appear. The return
     * value <code>-1</code> indicates that the attribute was not initialized.
     *
     * @return the begin line of the file where this symbol appear or
     *         <code>-1</code> if it was not initialized.
     */
    ...
    /**
     * Return the begin column of the file where this symbol appear. The return
     * value <code>-1</code> indicates that the attribute was not initialized.
     *
     * @return the begin column of the file where this symbol appear or
     *         <code>-1</code> if it was not initialized.
     */
    ...
    /**
     * Return the end line of the file where this symbol appear. The return
     * value <code>-1</code> indicates that the attribute was not initialized.
     *
     * @return the end line of the file where this symbol appear or
     *         <code>-1</code> if it was not initialized.
     */
    ...
    /**
     * Return the end column of the file where this symbol appear. The return
     * value <code>-1</code> indicates that the attribute was not initialized.
     *
     * @return the end column of the file where this symbol appear or
     *         <code>-1</code> if it was not initialized.
     */
    ...
    /**
     * Renames the symbol from a specified index. The symbol is renamed if only
     * if this symbol is a variable, otherwise nothing is done. After rename
     * operation the variable will have the form <code>?Xn</code> where
     * <code>n</code> is the specified index.
     *
     * @param index the index of the symbol.
     * @return the old image of the symbol or null if the symbol was not
     *         renamed.
    ...
    /**
     * Renames the symbol from a specified symbolEncoding. The symbol is renamed
     * if only if this symbol is a variable, otherwise nothing is done.
     *
     ...
     * @return <tt>true</tt> if this symbol is equal to <tt>object</tt>, i.e.,
     *         <tt>other</tt> is not null and of kind <tt>Symbol</tt> and it has
     *         the same image; otherwise return <tt>false</tt>.
