...
public abstract class AbstractPlanner implements Planner
{
     ...
     *
     * @param timeout the time allocated to the search in second. Timeout mus be
     *            positive.
     */
    @Override
     ...
     *
     * @return the time out of the planner, i.e., the time allocated to the
     *         search in second.
     */
    @Override
     ...
     *
     * @param level the trace level of the planner. Trace level must be
     *            positive.
     */
    @Override
