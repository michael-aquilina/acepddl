...
public class ProblemFactory
{
     ...
     * @throws FileNotFoundException if the domain or the problem file was not
     *             found.
     * @throws IOException if an error occur during parsing.
     */
    public ErrorManager parse(final File domain, final File problem)
            throws IOException
    {
     ...
     * @throws IOException if an error occur during parsing
     */
    public ErrorManager parse(final String domain, final String problem)
            throws IOException
    {
     ...
     *
     * @return the encoded planning problem or null if the problem cannot be
     *         encoded.
     */
     ...
     * </ol>
     * <ol>
     * info on problem constants, types and predicates
     * </ol>
     * <ol>
     * 1 + loaded operators, initial and goal state
     * </ol>
     * <ol>
     * 1 + predicates and their inertia status
     * </ol>
     * <ol>
     * 1 + 3 + goal state and operators with unary inertia encoded
     * </ol>
     * <ol>
     * 1 + actions, initial and goal state after expansion of variables
     * </ol>
     * <ol>
     * 1 + final domain representation
     * </ol>
     * </ul>
     *
