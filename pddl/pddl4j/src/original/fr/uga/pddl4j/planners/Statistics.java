...
/**
 * The class implements the statistics of the planner, search time, memory used,
 * etc.
 *
 * @author D. Pellier
...
public class Statistics
{
    ...
    /**
     * Creates a new statistics object to store statistical information about
     * planner performances. The default statistic values are set to 0.
     *
     */
    public Statistics()
    {
    ...
    /**
     * Returns the path to the file containing the description of the solved
     * problem.
     *
     * @return the path to the file containing the description of the solved
     *         problem.
     */
    ...
    /**
     * Sets the path to the file containing the description of the solved
     * problem.
     *
     * @param problem the path to the file containing the description of the
     *            solved problem.
     */
    ...
    /**
     * Returns the encoding time, i.e., the time to encode the planning problem
    ...
    /**
     * Return the parsing time, i.e., the time needed to parser the domain and
    ...
    /**
     * Sets the encoding time, i.e., the time to encode the planning problem in
    ...
    /**
     * Sets the parsing time, i.e., the time needed to parser the domain and the
     * problem description.
     *
    ...
    public String toString()
    {
        ...
        final double timeToParseInSeconds = Statistics
                .millisecondToSecond(this.timeToParse);
        final double timeToEncodeInSeconds = Statistics
                .millisecondToSecond(this.timeToEncode);
        final double timeToSearchInSeconds = Statistics
                .millisecondToSecond(this.timeToSearch);
        final double totalTimeInSeconds = timeToParseInSeconds
                + timeToEncodeInSeconds + timeToSearchInSeconds;
        final double memoryForProblemInMBytes = Statistics
                .byteToMByte(this.memoryForProblem);
        final double memoryUsedToSearchInMBytes = Statistics
                .byteToMByte(this.memoryUsedToSearch);
        final double totalMemoryInMBytes = memoryForProblemInMBytes
                + memoryUsedToSearchInMBytes;

        strb.append(String.format("* Problem features:%n"));
        strb.append(String.format("%8d number of actions %n",
                this.numberOfActions));
        strb.append(String.format("%8d number of relevant facts %n",
                this.numberOfRelevantFacts));
        strb.append(String.format("%n* Time spent:%n"));
        strb.append(String.format("%8.2f seconds parsing %n",
                timeToParseInSeconds));
        strb.append(String.format("%8.2f seconds encoding %n",
                timeToEncodeInSeconds));
        strb.append(String.format("%8.2f seconds searching%n",
                timeToSearchInSeconds));
        strb.append(String.format("%8.2f seconds total time%n",
                totalTimeInSeconds));
        strb.append(String.format("%n* Memory used:%n"));
        strb.append(String.format("%8.2f MBytes for problem representation%n",
                memoryForProblemInMBytes));
        strb.append(String.format("%8.2f MBytes for searching%n",
                memoryUsedToSearchInMBytes));
        strb.append(
                String.format("%8.2f MBytes total%n%n%n", totalMemoryInMBytes));
