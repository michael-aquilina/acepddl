...
/**
 * This abstract class implements the common part of an operator what ever its
 * representation, i.e., integer or bit set.
 *
 * @author D. Pellier
...
public abstract class AbstractCodedOp implements CodedOp
{
    ...
    /**
     * The list of parameters of the operator. The integer value correspond to
    ...
    /**
     * The flag used to indicate if the operator is dummy. By default, an
     * operator is not dummy.
     */
    ...
    protected AbstractCodedOp(final BitOp other)
    {
        ...
        System.arraycopy(other.parameters, 0, this.parameters, 0,
                other.getArity());
        this.instantiations = new int[other.getArity()];
        System.arraycopy(other.instantiations, 0, this.instantiations, 0,
                other.getArity());
    ...
    protected AbstractCodedOp(final String name, final int arity,
            final double duration, final double cost)
    {
        this.setName(name);
    ...
    /**
     * Creates a new operator. The default cost and duration of the operator is
     * set to 1.0.
     *
     * @param name the name of the operator.
     ...
     *             <code>parameters.length != instantiations.length</code>.
     */
    protected AbstractCodedOp(final String name, final int[] parameters,
            final int[] instantiations)
    {
        ...
        if (parameters.length != instantiations.length)
        {
            throw new IllegalArgumentException(
                    "parameters.length != instantiations.length");
        }
    ...
    /**
     * Instantiate a parameter of the operator at a specified index with a
     * value.
     * <p>
     ...
     *
     * @return <code>true</code> if the operator is dummy; <code>false</code>
     *         otherwise.
     */
     ...
     * method returns <code>true</code> if the object is a not null instance of
     * the class <code>CodedOp</code> and both operator have the same name.
     *
    ...
    /**
     * Returns a hash code value for this operator. This method is supported for
