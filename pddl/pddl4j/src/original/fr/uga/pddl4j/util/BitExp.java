...
public class BitExp implements Serializable
{
    ...
    /**
     * Creates a new bit set expression. By default the expression has no
     * positive and no negative fact.
     */
    public BitExp()
    {
    ...
    /**
     * Creates a new bit expression from a specified positive and negative bit
     * set that represent respectively the positive and the negative fact of the
     * expression.
     *
     ...
     * object is equal to the expression if and only if the object is an
     * instance of the class <code>BitExp</code> and it has the same positive
     * and negative facts.
     *
