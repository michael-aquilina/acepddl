...
public class BitVector extends BitSet
{
    ...
    /**
     * Creates a new <code>BitVector</code> from a specified
     * <code>BitExp</code>.
     *
     * @param exp the <code>BitExp</code> that represents
     *            <code>BitVector</code>.
     */
    ...
    /**
     * Creates a new <code>BitVector</code> from an other state. This
     * constructor is the copy constructor.
     *
     ...
     * <code>BitVector</code>. In other word, this method returns
     * <code>true</code> if all the bits set to 1 in the specified vector are
     * also set to 1 in this vector.
     *
     ...
     * <code>BitVector</code>. In other word, this method returns
     * <code>true</code> if all the bits set to 1 in the specified vector are
     * set to 0 in this vector.
     *
     * @param vector the other bit vector.
     * @return <code>true</code> if this bit vector is included a other
     *         specified <code>BitVector</code>; <code>false</code> otherwise.
     */
    ...
    /**
     * Return a bit vector that represents the intersection of this bit vector
     * with an other.
     *
     * @param vector the other bit vector.
     * @return Return a bit vector that represents the intersection of this bit
     *         vector with an other.
     */
