 ...
 */
public class ACEPlannerActLink {
	...
	ACEPlannerConditionModel[] preconds; // List of factIDs for the preconditions of this action
	 ...
	 */
	public ACEPlannerActLink(int id, float d, int np, int ne, float e_cost) {
		actID = id;
		dur = d;
		...
		preconds = new ACEPlannerConditionModel[numPrec];
	 ...
	 *            exec_cost for this action
	 */
	public ACEPlannerActLink(int id, GMathForm mathform, int np, int ne, float e_cost) {
		actID = id;
		dur = 0;
	...
	public void addPrecond(ACEPlannerConditionModel fact, int index) {
		preconds[index] = fact;
	}
	...
	public ACEPlannerConditionModel getPrecond(int index) {
